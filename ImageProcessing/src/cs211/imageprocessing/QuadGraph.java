...
public class QuadGraph {
     ...
     * @param max_area the minimal area wanted
     * @param min_area the maximal area wanted
     * @return the 4 corners of a good quad
     */
    public PVector[] selectBestQuad(float max_area, float min_area){
        ...
        while(it.hasNext()){
            PVector[] n = it.next();
            if(!nonFlatQuad(n[0], n[1], n[2], n[3])){
                it.remove();
            }   
        }
        ...
        Comparator<PVector[]> comp = new Comparator<PVector[]>(){
            ...
            public int compare(PVector[] o1, PVector[] o2) {
                float area1 = area(o1[0], o1[1], o1[2], o1[3]);
                float area2 = area(o1[0], o1[1], o1[2], o1[3]);
